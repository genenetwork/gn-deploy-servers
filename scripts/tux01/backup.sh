...
sheepdog_run.rb -h rabbit -c 'rsync -va /home/redis/ --rsync-path=/usr/bin/rsync -e "ssh -i /home/mariadb/.ssh/id_backup" wrk@penguin2.genenetwork.org:/export/backup/tux01-redis/' --always -v --tag $tag

tag=RSYNC_GN2_PROD_TUX01_P2
sheepdog_run.rb -h rabbit -c 'rsync -va /home/gn2/production/ --exclude tmp/ --rsync-path=/usr/bin/rsync -e "ssh -i /home/mariadb/.ssh/id_backup" wrk@penguin2.genenetwork.org:/export/backup/tux01-gn2/' --always -v --tag $tag
...
sheepdog_run.rb -h rabbit -c 'rsync -va /home/backup/tux01_mariadb_new --rsync-path=/usr/bin/rsync -e "ssh -i /home/mariadb/.ssh/id_backup" wrk@penguin2.genenetwork.org:/export/backup/tux01-mariadb-new' --always -v --tag $tag
